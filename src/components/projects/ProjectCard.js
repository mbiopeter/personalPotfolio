...
const ProjectCard = ({ item }) => {
    return (
        <div className="w-full px-12 py-10 rounded-lg shadow-shadowOne flex flex-col bg-gradient-to-r from-bodyColor to-[#202327] group hover:bg-gradient-to-b hover:from-gray-900 hover:to-gray-1000 transition-colors duration-1000">
